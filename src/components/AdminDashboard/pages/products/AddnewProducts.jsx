...
const AddnewProducts = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (Array.isArray(product_filter) && product_filter.length > 0) {
      product_filter.forEach(id => {
    ...
    Object.keys(restFormData).forEach((key) => {
      ...
      } else if (restFormData[key] !== undefined && restFormData[key] !== null) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Complete all steps to list your product successfully</p>
        </div>
