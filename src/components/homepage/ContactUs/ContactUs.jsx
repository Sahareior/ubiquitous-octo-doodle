...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare data for API - map "message" to "body" as required by API
      const apiData = {
        name: formData.name,
        email: formData.email,
        subject: formData.subject,
        body: formData.message // Map message field to body
      };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
